    ...
    def run(self, clock):
        ...
        while True:
            ...
            for i in range(4):
                ...
                pos_x = (WIN_WIDTH / 2 - 177) + 105 * i

                self.window.blit(place_frame, (pos_x, (WIN_HEIGHT / 2) - 30))
            ...
            for i in range(len(CHARACTER_OPTION)):               
                ...
                if i == character_option:
                    self.character_menu_text(
                        ...
                        CHARACTER_OPTION[i],
                        C_YELLOW,
                        ((WIN_WIDTH / 2 - 165) + 110 * i, (WIN_HEIGHT / 2) + 30),
                    )
                    self.character_menu_text(
                        12,
                        "descricao",
                        C_YELLOW,
                        ((WIN_WIDTH / 2 - 165) + 110 * i, (WIN_HEIGHT / 2) + 50),
                    )
                else:
                    self.character_menu_text(
                        16,
